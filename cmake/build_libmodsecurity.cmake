...
# When CI enables sccache, route the ENGINE compilation (~230 TUs) through
# it via CMake launchers on the engine configure line below. Conan-built
# dependencies cannot use this (no supported launcher conf in Conan 2.x);
# they stay uncached and rebuild only on cold engine-cache misses.
set(_launcher_args "")
if(DEFINED ENV{SCCACHE_GHA_ENABLED})
    set(_launcher_args "-DCMAKE_C_COMPILER_LAUNCHER=sccache;-DCMAKE_CXX_COMPILER_LAUNCHER=sccache")
endif()
